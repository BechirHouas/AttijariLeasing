    ...
    private  String addSubCategory (String SubCategoryName, String categoryName){
        ...
        if (SubCategoryName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany ="INSERT INTO  `attijarileasing`.`sub-category` (`subcategory_id` ,`sub-category_name` ,`category_name`)VALUES (NULL ,  '"+SubCategoryName+"',  '"+categoryName+"');"; 
